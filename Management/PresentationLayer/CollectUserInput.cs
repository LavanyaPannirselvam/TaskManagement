...
namespace TaskManagementApplication.Presentation
{
    public class CollectUserInput
    {
        ...
        //private readonly SigningProcess _signingProcess = new();
        int adminId;
        string? name;
        string? email;
        string? password;
        ...
        /*public string CollectSignUpInput()
        {
            ...
            GetAndSetRole();
            return _signingProcess.SignUp(name!, email!, role, password!);
        }*/
        ...
        {
            GetAndSetEmail();
            return _signingProcess.SignOutUser(email!);
        }*/
        ...
        {
            ColorCode.DefaultCode("Enter userId".PadRight(20) + " : ");
